...
mkdir -p ./libraries/vga_pio/
mkdir -p ./libraries/m10k_pll/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_vga_pio.vo"                         -work vga_pio                   -cdslib ./cds_libs/vga_pio.cds.lib                  
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_m10k_pll.vo"                        -work m10k_pll                  -cdslib ./cds_libs/m10k_pll.cds.lib                 
